describe('SmartPhone', () => {
  ...
  describe('displayFeatures() method', () => {
    ...
    it("should return the all features of the smart phone in next next lines (use '\\n' escape sequence for new line)", () => {
      expect(smartPhone.displayFeatures()).toEqual(
        ram + '\n' + batteryPower + '\n' + price,
      )
    })
  })
...
describe('AndroidPhone', () => {
  ...
  describe('displayFeatures() method', () => {
    ...
    it("should return the all features of the smart phone in next next lines (use '\\n' escape sequence for new line)", () => {
      expect(androidPhone.displayFeatures()).toEqual(
        modelName + '\n' + ram + '\n' + batteryPower + '\n' + price,
      )
    })
  })
  ...
  describe('remainingAmount() method', () => {
    ...
    it('should return "Customer has remaining Rs.AMOUNT after buying the android phone", if customer has more amount than actual price of the phone', () => {
      expect(androidPhone.remainingAmount(25500)).toEqual(
        `Customer has remaining Rs.${androidPhone.price} after buying the android phone`,
      )
      expect(androidPhone.remainingAmount(25000)).toEqual(
        `Customer has remaining Rs.${androidPhone.price} after buying the android phone`,
      )
    })

    it('should return "Customer has no more amount", if customer has equal amount as same as actual price of the phone', () => {
      expect(androidPhone.remainingAmount(24000)).toEqual(
...
describe('IPhone', () => {
  ...
  describe('displayFeatures() method', () => {
    ...
    it("should return the all features of the smart phone in next next lines (use '\\n' escape sequence for new line)", () => {
      expect(iphone.displayFeatures()).toEqual(
        seriesName + '\n' + ram + '\n' + batteryPower + '\n' + price,
      )
    })
  })
  ...
  describe('remainingAmount() method', () => {
    ...
    it('should return "Customer has remaining Rs.AMOUNT after buying an iphone", if customer has more amount than actual price of the phone', () => {
      expect(iphone.remainingAmount(65500)).toEqual(
        `Customer has remaining Rs.${iphone.price} after buying an iphone`,
      )
      expect(iphone.remainingAmount(65000)).toEqual(
        `Customer has remaining Rs.${iphone.price} after buying an iphone`,
      )
    })

    it('should return "Customer has no more amount", if customer has equal amount as same as actual price of the phone', () => {
      expect(iphone.remainingAmount(64000)).toEqual(
        'Customer has no more amount',
      )
    })

    it('should return "Customer can\'t able to buy the phone", if customer has less amount than actual price of the phone', () => {
      expect(iphone.remainingAmount(24000)).toEqual(
...
describe('MobileCampus', () => {
  ...
  describe('changeMobileAvailabilityNumber() method', () => {
    it('should be a function', () => {
      expect(typeof mobileCampus.changeMobileAvailabilityNumber).toBe(
        'function',
      )
    })
    ...
    it('should find the remaining mobiles available', () => {
      ...
      if (mobileType === 'android') {
        expect(mobileCampus.NoOfAndroidMobiles).toEqual(
          NoOfAndroidMobiles - 500,
        )
      }
    ...
    it('should return "Available android mobiles are COUNT" after buying some mobiles', () => {
      expect(
        mobileCampus.changeMobileAvailabilityNumber(500, 'android'),
      ).toEqual(
        `Available android mobiles are ${mobileCampus.NoOfAndroidMobiles}`,
      )
    })

    it('should return "Available iphone mobiles are COUNT" after buying some mobiles', () => {
      expect(
        mobileCampus.changeMobileAvailabilityNumber(500, 'iphone'),
      ).toEqual(
        `Available iphone mobiles are ${mobileCampus.NoOfIPhoneMobiles}`,
      )
    })
  })
})
